...
VALUES ('entrance-ticket-to-chambord-castle',
        'Entrance ticket to Chambord Castle',
        'Chambord',
        'Attractions & guided tours',
        22.00, 4.7, 110,
        'https://images.musement.com/cover/0072/36/chateau-de-chambord-1-jpg_header-7135742.jpeg?q=50&fit=crop&auto=format&w=1680&h=600&dpr=1'),
...
INSERT INTO reviews (experience_id, author, comment, rating, created_at)
VALUES ((SELECT id FROM experiences WHERE slug = 'entrance-ticket-to-chambord-castle'),
